...
\node[
  ...
  \includegraphics[width=0.88cm]{../static/crystal.png}\\[-2pt]
  \textbf{Chemical}\\[-2pt]
  \textbf{descriptors}
};
...
\node[
  ...
  \includegraphics[width=0.88cm]{../static/target.png}\\[-2pt]
...
\node[
  ...
  \includegraphics[width=0.46cm]{../static/chemists.png}\\[-2pt]
  \textbf{Author}\\[-2pt]
  0.76
};
...
\node[
  ...
  \includegraphics[width=0.46cm]{../static/journal.png}\\[-2pt]
  \textbf{Journal}\\[-2pt]
  0.82
};
...
\node[
  ...
  \includegraphics[width=0.46cm]{../static/calendar.png}\\[-2pt]
  \textbf{Year}\\[-2pt]
  1.00
};
