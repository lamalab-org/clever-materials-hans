...
def _(df_final, run_meta_comparison_analysis, target_column):
    ...
    print(f"Perovskite Meta-information comparison:")
...
@app.cell
def _(create_main_figure_panel_with_meta_comparison, meta_comparison, paths, perovskite_top10_labels):
    ...
    fig_main_four_col = create_main_figure_panel_with_meta_comparison(
        ...
        dataset_name="Perovskite Top 10% PCE",
        metric_labels=perovskite_top10_labels,
        save_path=paths.figures / "perovskite_top10_main_panel_four_columns.pdf",
        selection_metric="accuracy"
    )
    fig_main_four_col
